...
class TensormeterRTM1Client:
    ...
    # @property
    # def avgt(self):
    #     return self._data["avgt"]

    # @avgt.setter
    # def avgt(self, value):
    #     self.send(b"avgt", struct.pack(">d", value))
    ...
    # @lfrq.setter
    # def lfrq(self, value):
    #     self.send(b"lfrq", struct.pack(">d", value))
    ...
    # @vamp.setter
    # def vamp(self, value):
    #     self.send(b"vamp", struct.pack(">d", value))
    ...
    # @vpro.setter
    # def vpro(self, value):
    #     self.send(b"vpro", struct.pack(">d", value))
    ...
    # @camp.setter
    # def camp(self, value):
    #     self.send(b"camp", struct.pack(">d", value))
    ...
    # @cpro.setter
    # def cpro(self, value):
    #     self.send(b"cpro", struct.pack(">d", value))
    ...
    # @vodc.setter
    # def vodc(self):
    #     self.send(b"vodc", struct.pack(">d", value))
    ...
    # @vodc.setter
    # def cudc(self):
    #     self.send(b"cudc", struct.pack(">d", value))
    ...
    # @virg.setter
    # def virg(self, value):
    #     self.send(b"virg", struct.pack(">d", value))
    ...
    # @vorg.setter
    # def vorg(self, value):
    #     self.send(b"vorg", struct.pack(">d", value))
